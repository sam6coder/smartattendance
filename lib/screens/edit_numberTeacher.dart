...
class EditMobileTScreen extends StatefulWidget {
  @override
  EditMobileTScreenState createState() => EditMobileTScreenState();
}

class EditMobileTScreenState extends State<EditMobileTScreen> {
    ...
    return PopScope(
      ...
      onPopInvoked: (didPop) async {
        ...
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => ProfileTeacherScreen()));
      },
      child: Scaffold(
          key: scaffoldKey,
